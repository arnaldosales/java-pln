...
public class SPHelper {
	...
	private static final Logger log = Logger.getLogger(SPHelper.class);
	...
	public void escreverHierarquia(String texto) {

		log.info("Texto de entrada: " + texto);

		List<TaggedWord> lTags = this.getListTaggerWord(texto);
		log.info("Lista de tags" + lTags.toString());
	...
	private boolean isNN(TaggedWord tag) {

		try {

			String t = tag.tag();
			return t.startsWith("NN");
